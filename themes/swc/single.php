...
<!-- MODAL -->
<div class="modal fade" id="blogsubscribe" tabindex="-1" role="dialog" aria-labelledby="blogsubscribe">
  <div class="modal-dialog subscribe" role="document">
    <div class="modal-content">
     
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Get SWC Blog Updates</h4>
      </div>
     
 <div class="modal-body">
<?php echo do_shortcode('[formidable id=34]'); ?>
  </div>
